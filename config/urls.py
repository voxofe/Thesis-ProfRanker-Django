...
urlpatterns = [
    ...
    path('api/phd/check', views.phd_check_create, name='phd_check_create'),
    path('api/phd/check/<int:check_id>', views.phd_check_detail, name='phd_check_detail'),
    path('api/phd/check/latest', views.phd_check_latest, name='phd_check_latest'),
